...
- **Version**: [2.0]
- **Creation Date**: [2025-7-20]# <span style="color: red;">P2</span>: A <span style="color: red;">P</span>urified Painting Style Classification Dataset (v<span style="color: red;">2</span>.0)
